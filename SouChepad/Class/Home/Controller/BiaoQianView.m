...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [layout setSectionInset:UIEdgeInsetsMake(0, 0, 10, 20)];
        UICollectionView *biaoqianview = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, frame.size.width, frame.size.height) collectionViewLayout:layout];
